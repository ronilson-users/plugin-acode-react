...
export const snippets = [
...

	{
		...
		snippet: `export default function FILE_NAME$1() {
    return (
      <>
        $2
      </>
...
export default function FILE_NAME$1() {
...
class FILE_NAME$1 extends Component {
  render() {
    return (
      <View style={styles.container}>
        <Text>Your Text</Text>
...

{
	...
	type: 'snippet RN',
	description: 'Snippet to create an object in JavaScript Persona',
},
...
{/* Seu componente personalizado aqui */}
		...
		type: 'snippet RN',
		description: 'Creat snippet from  component personalized',
	},
